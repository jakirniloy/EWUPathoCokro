...
<body>
    ...
    <section id="container">
        ...
        <header class="header white-bg">
            ...
            <!--logo start-->
            <a href="index.php" class="logo"><span> পাঠচক্র</span></a>
            <!--logo end-->
    ...
    if($userData['role'] == 1){ ?>
                    ...
                    <?php } ?>
                    <li class="sub-menu">
                        <a href="javascript:;" <?= $page == 'inbox.php' ? 'class="active"' : '' ?>
                    ...
                    <li class="sub-menu">
                        <a href="javascript:;" <?= $page == 'logo.php' ? 'class="active"' : '' ?>
                            <?= $page == 'social.php' ? 'class="active"' : '' ?>>
