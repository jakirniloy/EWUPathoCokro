    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7">
                <div class="widget">
                    <div class="footer-text text-left">
                        <a href="index.php"><img src="uploads/ppp.png" alt="" width="200" height="200" class="img-fluid"></a>
                        <p>বাংলাদেশের বেসরকারি বিশ্ববিদ্যালয়গুলোর মধ্যে গড়ে ওঠা প্রথম বাংলা সাহিত্য সংঘ- "পাঠচক্র।"</p>
                        <div class="social">
            ...
            <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12">
                <div class="widget">
                    ...
                    <div class="link-widget">
                        <ul>
                            <li><a href="https://niloyvaw.blogspot.com/">About us</a></li>
                            <li>
                                <a href="http://localhost/EWUPathoCokro/admin/login.php">
        ...
        <div class="row" >
            <div class="col-md-12 text-center">
                <br>
                <div class="copyright"> 2023 © Developed by :  <a href="https://github.com/jakirniloy"> Jakir Hossain Niloy</a>.</div>
            </div>
        </div>
    </div><!-- end container -->
</footer><!-- end footer -->
